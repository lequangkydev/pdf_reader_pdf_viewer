...
abstract class AppConfigModel with _$AppConfigModel {
  ...
  const factory AppConfigModel({
    ...
    @Default(true) bool enableReRender,
    @Default(false) bool optimizeLanguage,
...
abstract class ScreenFlow with _$ScreenFlow {
  ...
  const factory ScreenFlow({
    ...
    @Default(true) bool showLanguage,
    @Default(true) bool showIntro,
    // @Default(false) bool enableIntro3,
    @Default(1) int typeDefaultPermission,
  }) = _ScreenFlow;
