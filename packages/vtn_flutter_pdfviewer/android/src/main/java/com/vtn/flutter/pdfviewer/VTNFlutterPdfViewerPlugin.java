package com.vtn.flutter.pdfviewer;
...
public class VTNFlutterPdfViewerPlugin implements FlutterPlugin, MethodCallHandler {
  ...
  public void onAttachedToEngine(@NonNull FlutterPluginBinding flutterPluginBinding) {
    channel = new MethodChannel(flutterPluginBinding.getBinaryMessenger(), "vtn_flutter_pdfviewer");
