...
public class SwiftVTNFlutterPdfViewerPlugin: NSObject, FlutterPlugin {
    // Document repository
    var documentRepo = [String: CGPDFDocument?]()
    
    let dispatcher = DispatchQueue(label: "vtn_flutter_pdfviewer")

    public static func register(with registrar: FlutterPluginRegistrar) {
        let channel = FlutterMethodChannel(name: "vtn_flutter_pdfviewer", binaryMessenger: registrar.messenger())
        let instance = SwiftVTNFlutterPdfViewerPlugin()
